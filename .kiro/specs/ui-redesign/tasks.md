...
- [x] 1. 建立设计系统基础
  - [x] 1.1 创建设计令牌配置文件
    ...
    - **✅ 已完成并优化** - 更新为 Sugar CRM 风格的柔和配色
    - _Requirements: 1.1, 1.2, 1.3, 1.4, 1.5_

  - [x] 1.2 配置 Tailwind CSS
    - 更新 `tailwind.config.js` 使用设计令牌
    - 添加自定义工具类
    - **✅ 已完成** - 项目使用 Ant Design，已集成主题系统
...
- [x] 2. 创建基础组件库
  ...
  - [x] 2.6 实现 Badge 组件
    ...
    - 支持不同颜色变体
    - 支持不同尺寸
    - **✅ 已完成并修复** - 修复 dot 模式的 TypeScript 错误
    - _Requirements: 6.4_
...
- [ ] 3. 升级 Dashboard 页面
  - [x] 3.1 重构统计卡片
    ...
    - 优化图标和数值展示
    - 添加悬停效果
    - **✅ 已完成** - 商务人员和工厂老板仪表盘都已升级，使用新 Card 组件，添加背景装饰和毛玻璃效果
...
- [ ] 9. 升级 Admin 页面
  - [x] 9.1 重构工厂列表
    - 优化表格样式
    - 添加卡片视图选项
    - **✅ 已完成** - 升级所有统计卡片和套餐分布卡片，添加背景装饰
    - _Requirements: 2.1_

  - [x] 9.2 优化统计卡片
    - 使用新的 Card 组件
    - 优化数据展示
    - **✅ 已完成** - 使用新 Card 组件，添加毛玻璃效果
    - _Requirements: 2.1_
...
- [ ] 10. 升级达人门户页面
  - [x] 10.1 重构达人仪表盘
    - 使用新的 Card 组件
    - 优化数据展示
    - **✅ 已完成** - Dashboard 页面升级完成
    - _Requirements: 2.1_

  - [x] 10.2 优化合作列表
    - 使用新的 Card 组件
    - 添加状态标签
    - **✅ 已完成** - Collaborations 页面升级完成
    - _Requirements: 2.1, 6.4_
  ...
  - [x] 10.5 优化合作详情页
    - 使用新的 Card 组件
    - 优化详情展示
    - **✅ 已完成** - CollaborationDetail 页面升级完成
    - _Requirements: 2.1_
