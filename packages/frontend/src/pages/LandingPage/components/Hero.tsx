        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="relative px-8 py-4 bg-brand-600 text-white font-bold rounded-2xl flex items-center gap-2 shadow-xl shadow-brand-500/20 overflow-hidden group border-0 cursor-pointer"
            >
            ...
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white hover:bg-slate-50 text-slate-700 font-bold rounded-2xl border border-slate-200 shadow-sm flex items-center gap-2 transition-colors cursor-pointer"
            >
