        ...
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a 
              ...
              className="text-slate-600 hover:text-brand-600 transition-colors text-sm font-bold hidden md:block"
            >
              登录
            </a>
            <a 
              href="http://localhost:5173/register"
              className="bg-brand-600 hover:bg-brand-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-lg shadow-brand-500/30 hover:-translate-y-0.5 inline-block"
            >
              免费试用
            </a>
          </div>
      ...
      <main className="flex-grow">
        ...
        <section className="py-32 bg-brand-600 relative overflow-hidden text-center">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <a 
              href="http://localhost:5173/register"
              className="inline-block px-10 py-5 bg-white text-brand-700 font-bold text-lg rounded-2xl hover:bg-brand-50 transition-all transform hover:-translate-y-1 shadow-2xl shadow-black/20"
            >
              开始免费试用
            </a>
          </div>
